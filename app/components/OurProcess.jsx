...
const OurProcess = () => {
    return (
        <div className="py-37.5 flex flex-col gap-4 items-center max-w-225 w-full mx-auto">
            ...
            <div className="flex flex-col gap-0.5 items-center">
                ...
                <p className="font-medium text-lg leading-7 tracking-0.18 max-w-116.5 text-center">A quick overview of how we work together to make your </p>
            </div>
                <ProcessCard />
            {/* </div> */}
        </div>
